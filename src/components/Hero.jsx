...
const Hero = () => {
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div
        className={`absolute inset-0 top-26 max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}
      >
      ...
      <div className='absolute xs:bottom-10 lg:bottom-32 bottom-50 w-full flex justify-center items-center'>
        <a href='#about'>
